...
widgetAc(matchId){
  ...
  window.$('.no-statistic').remove();
  console.log(matchId)
      window.SRLive.addWidget("widgets.lmts", {
              "height": "auto",
              "showScoreboard": true,
              "showMomentum": false,
              "showMomentum2": false,
              ...
              "matchId": matchId,
              "showTitle": false,
              "container": ".wc-widget_1"
          });
          window.SRLive.addWidget("widgets.matchlineups", {
              "matchId": matchId,
              "height": "auto",
              "showTitle": false,
              "container": ".wc-widget_2"
          });
          window.SRLive.addWidget("widgets.matchcommentary", {
              "matchId": matchId,
              "height": "auto",
              "showTitle": false,
              "container": ".wc-widget_3"
          });
}
  ngOnInit() {}
